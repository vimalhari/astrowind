...
const caseStudyCollection = defineCollection({
  ...
  schema: z.object({
    ...
    challenge: z.object({
      ...
      points: z.array(z.string().min(10, 'Challenge point too short')).min(1, 'At least one challenge point required'),
    ...
    features: z.array(
      z.object({
        ...
        benefits: z.array(z.string().min(5, 'Benefit description too short')).min(1, 'At least one benefit required'),
        category: z.enum(['User Experience', 'Performance', 'Security', 'Scalability', 'Accessibility', 'SEO', 'Integration', 'Other']).optional(),
