...
results:
  performance:
    - metric: 'Page Load Speed'
      before: 'X seconds'
      after: 'Y seconds'
      improvement: '200%' # Use format like "200%" or just "Improved"
    - metric: 'Lighthouse Score'
      before: 'X/100'
      after: 'Y/100'
      improvement: '50%' # Use format like "50%" or just "Excellent"
    # Add more performance metrics as needed
  business:
    - metric: 'Conversion Rate'
      improvement: '25%' # Use format like "25%" or just "Increased"
    - metric: 'User Engagement'
      improvement: '150%' # Use format like "150%" or just "Improved"
