...
results:
  performance:
    ...
    - metric: "First Contentful Paint"
      before: "2.8 seconds"
      after: "0.8 seconds"
      improvement: "250% improvement"
    - metric: "Core Web Vitals"
      before: "Poor (Red)"
      after: "Good (Green)"
      improvement: "All metrics optimized"
  business:
    - metric: "User Engagement"
      improvement: "150% increase in session duration"
    - metric: "Conversion Rate"
      improvement: "75% increase in mortgage inquiries"
    - metric: "Mobile Traffic"
      improvement: "200% increase in mobile conversions"
    - metric: "Search Rankings"
      improvement: "Average 40% improvement in keyword positions"
